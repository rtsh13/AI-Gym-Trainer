        ...
        with mp_pose.Pose(min_detection_confidence=0.5, min_tracking_confidence=0.6) as pose:
            while cap.isOpened():
                ...
                try:
                    ...
                    # Get coordinates
                    leftShoulder,leftElbow,leftWrist,leftHip,leftKnee,rightShoulder,rightElbow,rightWrist,rightHip,rightKnee=get_coordinates(landmarks,tricepExt)
                    ...
                    hipAngleLeft = math.trunc(compute(leftShoulder,leftHip,leftKnee))
                    hipAngleRight = math.trunc(compute(rightShoulder,rightHip,rightKnee))
                    ...
                    if flag ==0:
                        if leftAngle < 50:
                            if hipAngleLeft<60 or hipAngleLeft>120:
                                print("Sit Straight")
                            else:
                                STAGE = "DOWN"
                        if leftAngle > 160 and STAGE =="DOWN":
                            if hipAngleLeft<60 or hipAngleLeft>120:
                                print("Sit Straight")
                            else:
                                STAGE="UP"
                        ...
                        if rightAngle < 50:
                            if hipAngleRight<60 or hipAngleRight>120:
                                print("Sit Straight")
                            else:
                                STAGE = "DOWN"
                        if rightAngle > 160 and STAGE =="DOWN":
                            if hipAngleRight<60 or hipAngleRight>120:
                                print("Sit Straight")
                            else:
                                STAGE="UP"
